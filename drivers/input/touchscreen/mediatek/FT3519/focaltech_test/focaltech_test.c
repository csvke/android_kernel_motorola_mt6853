...
// csvke: WIP: Not sure if declaring the fuction from static to non-static will cause any issue
void fts_test_save_data_csv(struct fts_test *tdata)
{
#if CSV_SUPPORT
    int i = 0;
    int j = 0;
...
EXPORT_SYMBOL(fts_test_save_data_csv);
